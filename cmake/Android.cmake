...
macro(android_create_apk name apk_package_name apk_directory)
  ...
  if(ANDROID_APK_INSTALL OR ANDROID_APK_RUN)
    add_custom_command(TARGET ${ANDROID_NAME}App COMMAND ${ANDROID_SDK}/platform-tools/adb install -r ${ANDROID_APK} WORKING_DIRECTORY "${apk_directory}")
  endif()

  # Start the application
  if(ANDROID_APK_RUN)
    add_custom_command(TARGET ${ANDROID_NAME}App COMMAND ${ANDROID_SDK}/platform-tools/adb adb shell monkey -p ${ANDROID_APK_PACKAGE} 1)
  endif()
